...
import { Search, Sparkles, ChevronDown, Mic, LayoutGrid, GalleryHorizontalEnd, Sun, Moon, BookOpen } from 'lucide-react';
                ...
                <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                          ...
                          <span className="tracking-wide hidden sm:inline">Casting</span>
                          <span className="tracking-wide sm:hidden">Casting</span>
                      </button>
                      
                      <button 
                          onClick={onOpenStoryMode}
                          className="flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white rounded-full text-xs sm:text-sm font-medium shadow-sm transition-all hover:scale-105 active:scale-95 group shrink-0"
                      >
                          <BookOpen size={14} className="text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-900 dark:group-hover:text-white transition-colors" />
                          <span className="tracking-wide hidden sm:inline">Story Mode</span>
                      </button>
                    </div>
                </div>
